...
var testData = []testDatum{
	...
	{"single lexeme", "&", []token.Type{{Value: "&", Type: token.Sticky}, eof}},
	{"single lexeme", "|", []token.Type{{Value: "|", Type: token.Sticky}, eof}},
	{"string literal", "\"abc\"", []token.Type{{Value: "\"abc\"", Type: token.StringLit}, eof}},
	{"escaped string literal", "\"a\\\"bc\"", []token.Type{{Value: "\"a\\\"bc\"", Type: token.StringLit}, eof}},
	{"string literal with new line", "\"a\nbc\"", []token.Type{{Value: "\"a\nbc\"", Type: token.StringLit}, eof}},
