...
func (i Int) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
...
func (b Bool) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
...
func (f Float) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
...
func (s String) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
...
func (l Local) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
	return bytecode.EncodeSrc(srcsel, bytecode.ADDR_LCL, int(l))
}

func (c Closure) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
	return bytecode.EncodeSrc(srcsel, bytecode.ADDR_CLS, int(c))
}

func (n Name) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
...
func (r Read) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
...
func (e Error) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
	instr := bytecode.New(bytecode.ERROR) | e.Value.byteCode(0, inFor, cs, ds)
	*cs = append(*cs, instr)
