...
func (i If) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
	...
	*cs = append(*cs, instr)
	...
	instr = bytecode.New(bytecode.JMP) | bytecode.EncodeSrc(0, bytecode.AddrImm, 4)
	*cs = append(*cs, instr)
...
func (i IfElse) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
	...
	*cs = append(*cs, instr)
	...
	// patch jmpf
	(*cs)[jmpfAddr] |=
		bytecode.EncodeSrc(2, bytecode.AddrImm, typErrAddr-jmpfAddr) |
			bytecode.EncodeSrc(1, bytecode.AddrImm, jmpTAddr-jmpfAddr+1)
	// patch jmp
...
func (w While) byteCode(srcsel int, inFor bool, cs *[]bytecode.Type, ds *[]value.Type) bytecode.Type {
	...
	*cs = append(*cs, instr)
	...
	(*cs)[jmpfAddr] |=
		bytecode.EncodeSrc(2, bytecode.AddrImm, typErrAddr-jmpfAddr) |
			bytecode.EncodeSrc(1, bytecode.AddrImm, len(*cs)-jmpfAddr)
