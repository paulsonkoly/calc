...
var testData = []TestDatum{
	...
	{"Bit flip ~true", value.NewBool(true), value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.TypeError},
	{"Bit flip ~false", value.NewBool(false), value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.TypeError},
	{"Bit flip ~int", value.NewInt(1), value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.NewInt(-2)},
	{"Bit flip ~float", value.NewFloat(1), value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.TypeError},
	{"Bit flip ~string", value.NewString("1"), value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.TypeError},
	{"Bit flip ~array", value.NewArray([]value.Type{value.NewInt(1)}), value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.TypeError},
	{"Bit flip ~function", emptyFunc, value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.TypeError},
	{"Bit flip ~error", value.ZeroDivError, value.NewBool(false), func(a, b value.Type) value.Type { return a.Flip() }, value.ZeroDivError},
